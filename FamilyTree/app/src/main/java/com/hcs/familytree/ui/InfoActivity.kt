        ...
        button.setOnClickListener {
            Flowable.create(FlowableOnSubscribe<FamilyMemberEntity> {
                ...
                if (mFamilyMember == null) {
                    mFamilyMember =
                        FamilyMemberEntity(tvName.text.toString())
                }
                ...
                when {
                    ...
                    spouseId != -1L -> {
                        ...
                        FamilyDataBaseHelper.getInstance(this).insertMember(mFamilyMember!!)
                        val nowId = FamilyDataBaseHelper.getInstance(this).countAll()
                        val memberEntity =
                            FamilyDataBaseHelper.getInstance(this).getFamilyMember(spouseId)
                        memberEntity.spouseId = nowId
                        FamilyDataBaseHelper.getInstance(this).updateMember(memberEntity)
                    }
                }
